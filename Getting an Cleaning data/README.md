...
This exercise is the project of getting and cleansing data course of John Hopkins on Coursera
All files included in this repository:
1. readme.md : explains all the files included
...
3. run_analysis_R: This script will do the following steps one after the other:

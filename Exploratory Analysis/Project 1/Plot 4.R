...
#second plot
with(data1,plot(Voltage,ylab="Voltage",xlab="datetime",type="l"))
#third plot
...
with(data1,plot(DateTime,Global_reactive_power,ylab="Global_reactive_power (kilowatts)",xlab="datetime",type="l",))
